...
function ready(){
    ...
    button.addEventListener('change' , removeCartItem);
    }
    // Quantity changes
...
var cartBoxContent = `
                    <img src="${productImg}" class="cart-image" height="150px" width="150px" alt="">
                      ...
                      <!-- Remove cart -->
                      <div class="cart-remove"><i class="fa fa-trash-o"></i></div>
                      `;
